...
@grails.plugin.springsecurity.annotation.Secured(value={"ROLE_ADMIN","ROLE_SUPERVISOR","ROLE_USER"}) @grails.transaction.Transactional(readOnly=true) public class LogBookController
...
public  java.lang.Object filteredListUserDate() { return null;}
}
